...
import { getUserDoc, recordLogin } from '../firebase/firestore'
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40"
        style={{
          backgroundImage: 'linear-gradient(rgba(99,112,241,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(99,112,241,0.06) 1px, transparent 1px)',
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card p-8 shadow-2xl shadow-black/40">
          <div className="mb-7">
            ...
            <p className="text-dark-400 text-sm mt-1 font-body">Sign in to access your courses</p>
          </div>
          ...
          <p className="text-center text-dark-500 text-xs mt-6 font-body">
