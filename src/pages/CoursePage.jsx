...
export default function CoursePage() {
  ...
  const handleMarkComplete = async () => {
    ...
    if (hasNext) {
      setTimeout(() => setActiveLesson(lessons[currentIndex + 1]), 1000)
    }
  }
  ...
  return (
    <div className="flex min-h-screen bg-dark-950">
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen overflow-hidden">
        ...
        {/* ── Top bar ──────────────────────────────────────────── */}
        <div className="sticky top-0 z-30 bg-dark-950/95 backdrop-blur-md border-b border-dark-800 px-6 py-3.5">
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate('/dashboard')}
              className="flex items-center gap-2 text-dark-400 hover:text-white transition-colors text-sm shrink-0"
            >
              <ArrowLeft size={15} />
            ...
            <div className="max-w-4xl mx-auto px-6 py-6 space-y-5">
              ...
              {lessons.length === 0 ? (
                <EmptyState
                  ...
                  description="This course has no lessons added yet. Check back later."
                />
              ) : !activeLesson ? (
                <EmptyState
                  icon={BookOpen}
                  title="Select a lesson"
                  description="Choose a lesson from the playlist to begin."
                />
              ) : (
                <>
                  {/* Video player */}
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      ...
                      disabled={!hasPrev}
                      className="btn-secondary px-4 py-2 text-xs disabled:opacity-30 disabled:cursor-not-allowed"
                    >
                  ...
                  <div className="card p-6">
                    ...
                    <div className="flex items-start gap-3 mb-1">
                      <div className="flex-1">
                        ...
                        <h2 className="text-xl font-display font-700 text-white leading-tight">
                          {activeLesson.title}
                        </h2>
                      </div>
                    </div>
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-2.5 px-5 py-2.5 rounded-lg
                                      ...
                                      ${marking
                                        ...
                                        : 'bg-brand-600 hover:bg-brand-500 text-white shadow-lg shadow-brand-600/25 hover:shadow-brand-500/30 hover:scale-[1.02]'
                                      }`}
                        >
                          {marking ? (
                            <>
                      ...
                      <div className="mt-4 flex items-center gap-3 px-4 py-3 rounded-xl
                        ...
                        <div>
                          ...
                          <p className="text-xs text-emerald-500 mt-0.5">
                            You've completed all {lessons.length} lessons in this course.
                          </p>
                        </div>
                      </div>
                    )}
